    ...
    <div className="w-screen h-screen">
      ...
      <div className="relative flex justify-center items-center">
        ...
        <div className="absolute">
          ...
          <p className="text-center font-sans text-white text-[20px]">
            THIS IS WHO WE ARE
          </p>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col md:flex-row justify-center mt-16">
        <div className="flex w-full md:w-1/2 justify-center">
          <img
            src={lifeat603}
            className=" m-3 xl:h-[500px] md:h-[450px] h-[300px] xl:w-[510px]"
          />
        </div>
        <div className="w-full md:w-1/2 mt-12 md:mt-0">
          <div className="mx-5 md:mx-0 md:mr-16">
            <h1 className="text-[#fcc519] font-bold text-[28px] md:text-[42px] my-3">
              Life at 603
            </h1>
            <p className="text-[#817a78] text-[16px] xl:text-[18px]">
            ...
            <p className="text-[#817a78] text-[16px] xl:text-[18px] mt-8">
              603 is a Mumbai based coworking space with a total of 8 centres, 7
              in Mumbai itself and 1 in Bangalore. 603 as a number defines “Your
      ...
      <div className="flex w-full flex-col-reverse md:flex-row">
        <div className="w-full md:w-1/2">
          <div className="bg-[#faf6c9] rounded-3xl p-3 m-3 md:mx-12 xl:ml-20 my-6">
            <h1 className="font-Raleway font-bold text-[26px] md:text-[32px] xl:text-[42px] text-[#3f3836]">
              Our Mission
            </h1>
            <p className="font-sans text-[#424242] text-[16px] xl:text-[18px] mt-6">
        ...
        <div className="w-1/2 bg-[#fcc519] flex items-center">
          <div className="flex flex-col">
            <div className="flex flex-col mx-12 ml-32">
              <h1 className="text-[54px] font-Raleway font-semibold text-white">
                Join a community of early stage startups.
              </h1>
              <p className="text-[16px] mt-10">
                Come join our high-energy environment of camaraderie, excitement
                and optimism that is going to shape the future of work.
              </p>
              <div className="mt-10">
                <button className="text-[18px] text-white bg-[#3f3836] px-8 py-4 border-l-2 border-white">
                  Book a Space
                </button>
              </div>
            </div>
        ...
        <div className="w-1/2">
          <div className="flex items-center w-full relative">
            <div className="h-[600px]">
              <img className="h-full" src={bgimage2} />
            </div>
            <div className="absolute flex flex-col w-[30%]">
              <div className="text-center flex flex-col bg-white py-8">
                ...
                <p className="text-[16px] text-[#3f3836] mx-4">
